...
// Source: https://github.com/tgrapperon/swift-dependencies-additions/blob/main/Sources/LoggerDependency/Logger.swift
...
public extension Logger {
  ...
  /// ```
  subscript(category category: String) -> Logger {
    Logger(subsystem: "org.prose.app", category: category)
  }
